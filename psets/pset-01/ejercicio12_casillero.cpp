...
public:
bool setnumeroCombinacion(int combinacion){
    if (combinacion<1000 or combinacion>9999){
        return false;
    }else{
    numeroCombinacion=combinacion;
        return true;
    }

}

double getcombinacion(){return numeroCombinacion;}
...
cout<<"Combinacion asignada: "<<std::boolalpha <<c1.setnumeroCombinacion(4821)<<endl;
cout<<"Numero: "<<c1.getcombinacion()<<endl ;

cout<<"Combinacion asignada: "<<std::boolalpha <<c1.setnumeroCombinacion(87)<<endl;
cout<<"Numero: "<<c1.getcombinacion()<<endl;
